...
const severityToNumber = (severity: Entry['headache_severity']) => {
  switch (severity) {
    case 'Mild':
      return 1;
    case 'Moderate':
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <Input type="checkbox" value={formData.site_of_pain_front || false} onChange={(e) => handleInputChange('site_of_pain_front', e.target.checked)} />
      </div>
      <div>
        <Label>Site of Pain Back</Label>
        <Input type="checkbox" value={formData.site_of_pain_back || false} onChange={(e) => handleInputChange('site_of_pain_back', e.target.checked)} />
      </div>
      <div>
        <Label>Site of Pain Left</Label>
        <Input type="checkbox" value={formData.site_of_pain_left || false} onChange={(e) => handleInputChange('site_of_pain_left', e.target.checked)} />
      </div>
      <div>
        <Label>Site of Pain Right</Label>
        <Input type="checkbox" value={formData.site_of_pain_right || false} onChange={(e) => handleInputChange('site_of_pain_right', e.target.checked)} />
      </div>
      <div>
        <Label>Site of Pain Top</Label>
        <Input type="checkbox" value={formData.site_of_pain_top || false} onChange={(e) => handleInputChange('site_of_pain_top', e.target.checked)} />
      </div>
      <div>
